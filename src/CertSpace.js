          ...
          <div class="card-container-1">
            <div class="content-card-divided">
              ...
              <div class="card-value">
                <AnimatedCounter
                  endValue={domainCount.parentDomainCount}
                  duration={1000}
                />
              </div>
              <div class="card-separator-line-divided"></div>
              ...
              <div class="card-value">
                <AnimatedCounter
                  endValue={domainCount.subDomainCount}
                  duration={1000}
                />
              </div>
            </div>
            {/* <div class="content-card-divided">
              ...
              <div class="card-value">
                <AnimatedCounter
                  endValue={
                    domainCount.phishingDomainMetrics.potentialPhishingCount
                  }
                  duration={1000}
                />
              </div>
              ...
              <div className="divided-card-bottom-container">
                <div className="divided-card-bottom-individual-container-1">
                  <div class="card-header">
                    <p class="card-header-txt-divided-bottom-left">
                      Registered
                    </p>
                  </div>
                  <div class="card-value">
                    <AnimatedCounter
                      endValue={
                        domainCount.phishingDomainMetrics
                          .registeredPhishingSites
                      }
                      duration={1000}
                    />
                  </div>
                ...
                <div className="divided-card-bottom-individual-container-2 ">
                  <div class="card-header">
                    <p class="card-header-txt-divided-bottom-right">
                      Unregistered
                    </p>
                  </div>
                  <div class="card-value">
            ...
            <div class="content-card">
              <div class="card-header">
                <p
                  ...
                  class="card-header-txt"
                >
                  {domainCount.metrics[0].title}
                </p>
              </div>
              <div class="card-separator-line"></div>
              <div class="card-value">
                <AnimatedCounter
                  endValue={domainCount.metrics[0].value}
                  duration={1000}
                />
              </div>
            </div>
            <div class="content-card">
              ...
              <div class="card-value">
                <AnimatedCounter
                  endValue={domainCount.metrics[1].value}
                  duration={1000}
                />
              </div>
            </div>
            <div class="content-card">
              ...
              <div class="card-value">
                <AnimatedCounter
                  endValue={domainCount.metrics[2].value}
                  duration={1000}
                />
              </div>
            </div>
            <div class="content-card">
              ...
              <div class="card-value">
                <AnimatedCounter
                  endValue={domainCount.metrics[3].value}
                  duration={1000}
                />
              </div>
            </div>
